...
if __name__ == "__main__":
    ...
    model_path = opt.test_pth

    dataName = ['VT821','VT1000','VT5000_test']

    for data in dataName:

        test_data_path = opt.test_path + data +"\\"   
        result_save_path = opt.pre + data +"\\"    
